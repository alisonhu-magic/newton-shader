...
const setCanvasSize = (page, w, h) => page.evaluate(([W, H]) => {
  window.__NF.setCanvasSize(W, H);
}, [w, h]);

module.exports = { FREEZE, open, settle, setInput, commitInput, fieldValue, pickSeg, expandAll, state, captureExport, setCanvasSize };
